...
public class InitiateBrowser_For_AdminLogin 
{
	...
	//	driver1.navigate().to("https://staging.legalops.com/admin");
		driver1.navigate().to("https://experts-staging.legalops.com/admin");
		driver1.findElement(By.xpath("//input[@id='user_email']")).sendKeys("admin@fxbytes.com");
